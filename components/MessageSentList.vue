    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          <h4 class="page-title">{{ $t('sent_messages') }}</h4>
        </div>
      </div>
    </div>
                ...
                <div class="d-inline-block d-md-none">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown-message-options">
                      <li><a href="/messages/sent" class="dropdown-item" @click.prevent="refresh" v-if="hasRole('admin') || can('message-view')">{{ $t('refresh') }}</a></li>
                ...
                <table class="table table-hover table-list">
                  <thead>
                    <tr>
                      ...
                      <th width="15%">
                        <sortable-column column="messages.sent_at" v-model="sort">{{ $t('sent_at') }}</sortable-column>
                      </th>
                  ...
                  <tbody>
                    <template v-for="message in messages">
                      <tr :class="{'table-active': selected.includes(message.id) }">
                        ...
                        <td>
                          <span v-if="message.sent_at">
                            {{ useDateFormat(message.sent_at, dateTimeFormat(currentUser)) }}
                          </span>
                          <span v-else> - </span>
                        </td>
                        <td class="text-end">
